...
public class InMemoryCatalog implements Catalog {
    ...
    public Collection<MusicItem> findByKeyword(String keyword) {
        ...
        for (MusicItem currentItem : catalogData) {
            if (currentItem.getTitle().toLowerCase(Locale.ROOT).contains(keyword.toLowerCase(Locale.ROOT)) || currentItem.getArtist().toLowerCase(Locale.ROOT).contains(keyword.toLowerCase(Locale.ROOT))) {
     ...
     */
    public Collection<MusicItem> getItemsAtSpecifiedPrice(double price) {
        Collection<MusicItem> result = new ArrayList<>();
